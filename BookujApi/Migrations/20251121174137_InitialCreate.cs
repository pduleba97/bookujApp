    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:appointment_status", "booked,completed,cancelled")
                .Annotation("Npgsql:Enum:subscription_status", "active,expired,cancelled")
                .Annotation("Npgsql:Enum:user_role", "client,employee,owner,admin");
